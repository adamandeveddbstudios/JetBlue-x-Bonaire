...
function setupContent(feed) {
  ...
  // destination_formatted = 'Miami, FL (MIA)'
     ...
     h4[0].innerHTML +=
   "<span class='sm blue'>New nonstop<br>flights from </span><br><span class='blue city'>" + "NYC" + "</span> <span class='blue to'>to<br></span> <span class='blue city'>" + "Bonaire (BON)" + "</span>";

  // h4[0].innerHTML +=
  //   "<span class='sm blue'>New nonstop<br>flights from </span><br><span class='blue city'>" +
  //   origin_formatted +
  ...
  if (showDefault) {
    h4[0].innerHTML =
      "<span class='default'><span class='go-width'>Go with</span><br><span class='jetblue'>jetBlue</span></span>"; // - Populates main headline
...
function animate() {
  ...
  tl.set(["#h4", "#priceHolder", "#cta", ".terms", "#terms_container"], {
    autoAlpha: 1,
    force3D: true,
  })
    ...
    .to("#main_content", 1.1, { y: "-=500", ease: Back.easeOut.config(0.3) })
